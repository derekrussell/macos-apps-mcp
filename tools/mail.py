...
TOOLS: list[Tool] = [
    ...
    Tool(
        ...
        description=(
            ...
            "A missing intermediate parent is auto-created, but only as a "
            "non-selectable IMAP container: it holds children but not messages, is "
            "absent from mail_list_mailboxes, and cannot be a mail_move destination "
            "or resolved by path. Create intermediate levels explicitly if you need "
            "them usable. "
